function init(){
    ...
    function displayChannels() {
      ...
      $.ajax({
        url: '/patient/channels-data/',  // Replace with the actual URL for your Django view
        type: 'GET',
        dataType: 'json',
        async: false,
      ...
      function switchChannel(channelId) {
        ...
        const url = '/patient/channels_patient/messages/' + channelId+'/'; // Replace '/your-url/' with the desired URL
