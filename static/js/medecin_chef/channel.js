function init(){
    ...
    function displayChannels() {
      ...
      $.ajax({
        url: '/medecin_chef/channels-data/',  // Replace with the actual URL for your Django view
        type: 'GET',
        dataType: 'json',
        async: false,
      ...
      function switchChannel(channelId) {
        ...
        const url = '/medecin_chef/channels_med/messages/' + channelId+'/'; // Replace '/your-url/' with the desired URL
