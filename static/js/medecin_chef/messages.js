...
let isScrolledToBottom = true;
    ...
    function back_to_messages_dashboard() {  
      const url = '/medecin_chef/channels_med/'; // Replace '/your-url/' with the desired URL
...
function sendMessage() {
   ...
   // time channel
    ...
    if (!!text) {
      ...
      $.ajax({
        url: '/medecin_chef/channels_med/messages/' + hiddenValue + '/',
        type: 'POST',
        headers: {
...
function showMessages() {
  ...
  $.ajax({
    url: '/medecin_chef/messages_data/'+ hiddenValue +'/',  // Replace with the actual URL for your Django view
    type: 'GET',
    dataType: 'json',
    async: false,
