function init(){
    ...
    function displayChannels() {
      ...
      $.ajax({
        url: '/receptionniste/channels-data/',  // Replace with the actual URL for your Django view
        type: 'GET',
        dataType: 'json',
        async: false,
        ...
        channels.forEach(channel => {
          ...
          newDiv.innerHTML = `
            ...
            <div class="message_dashboard_discution">
              ...
              <p><small>${channel.sender ? "You" : "patient"}</small></p>
            </div>
      ...
      function switchChannel(channelId) {
        ...
        const url = '/receptionniste/channels_receptionniste/messages/' + channelId+'/'; // Replace '/your-url/' with the desired URL
