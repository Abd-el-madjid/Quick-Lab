...
let isScrolledToBottom = true;
    ...
    function back_to_messages_dashboard() {  
      const url = '/receptionniste/channels_receptionniste/'; // Replace '/your-url/' with the desired URL
...
function sendMessage() {
   ...
   // time channel
    ...
    if (!!text) {
      ...
      $.ajax({
        url: '/receptionniste/channels_receptionniste/messages/' + hiddenValue + '/',
        type: 'POST',
        headers: {
...
function showMessages() {
  ...
  $.ajax({
    url: '/receptionniste/messages_data/'+ hiddenValue +'/',  // Replace with the actual URL for your Django view
    type: 'GET',
    dataType: 'json',
    async: false,
