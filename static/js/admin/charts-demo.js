...
// ... Rest of your code for other charts
  ...
  var chart3_main = document.querySelector('#chart-2');
  var chart3Data = JSON.parse(chart3_main.getAttribute('data-chart2'));
var chart3name = JSON.parse(chart3_main.getAttribute('data-name2'));
