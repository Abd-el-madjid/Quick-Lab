...
let isScrolledToBottom = true;
    ...
    function back_to_messages_dashboard() {  
      const url = '/infirmier/channels_inf/'; // Replace '/your-url/' with the desired URL
...
function sendMessage() {
   ...
   // time channel
    ...
    if (!!text) {
      ...
      $.ajax({
        url: '/infirmier/channels_inf/messages/' + hiddenValue + '/',
        type: 'POST',
        headers: {
...
function showMessages() {
  ...
  $.ajax({
    url: '/infirmier/messages_data/'+ hiddenValue +'/',  // Replace with the actual URL for your Django view
    type: 'GET',
    dataType: 'json',
    async: false,
